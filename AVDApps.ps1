# ==============================================================
# AVD Intune Enrollment & Sync – BULLETPROOF v3
# ==============================================================
...
Write-Log "=== AVD Intune Enrollment & Sync v3 Started ==="
...
try {
    ...
    if (-not $joinStatus) {
        ...
        try {
            ...
            Write-Log "WARNING: Entra ID join failed: $($_.Exception.Message). Proceeding."
        }
    }
    else {
    ...
    Write-Log "WARNING: Error checking Entra ID join: $($_.Exception.Message). Proceeding."
}
...
Write-Log "=== AVD Intune Sync v3 COMPLETE ==="
